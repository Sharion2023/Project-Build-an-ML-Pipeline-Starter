...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Name for cleaned output artifact to be uploaded to W&B",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Minimum price threshold; rows with price below will be dropped",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help ="Maximum price threshold; rows with price above will be dropped",
        required = True
    )
